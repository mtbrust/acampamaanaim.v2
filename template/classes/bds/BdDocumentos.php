...
class BdDocumentos extends DataBase
{
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            "nome"      => "VARCHAR(255) NULL",    // Nome/título do documento.
            "descricao" => "VARCHAR(1024) NULL",   // Descrição do documento. O que o documento é.
        ];
