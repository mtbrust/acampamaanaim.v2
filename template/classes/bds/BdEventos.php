...
class BdEventos extends DataBase
{
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            // Informações Evento
            "nome_evento"     => "VARCHAR(512) NULL",    // Nome técnico do evento.
            "titulo_evento"   => "VARCHAR(512) NULL",    // Título do Evento.
            "msg_espera"      => "VARCHAR(512) NULL",    // Mensagem que aparece na página inicial antes de liberar as inscrições.
            "nome_preletor"   => "VARCHAR(2048) NULL",   // Nome do preletor ou preletores.
            "obs_evento"      => "VARCHAR(4096) NULL",   // Observações gerais sobre o evento.
            "obs_preletor"    => "VARCHAR(4096) NULL",   // Observações gerais sobre o preletor.
            "obs_atividades"  => "VARCHAR(4096) NULL",   // Observações gerais sobre as atividades.
            "id_midia_banner" => "INT NULL",             // id tabela midia da foto banner.
            "id_midia_01"     => "INT NULL",             // id tabela midia da foto 01.
            "id_midia_02"     => "INT NULL",             // id tabela midia da foto 02.
            "id_midia_03"     => "INT NULL",             // id tabela midia da foto 03.
