...
class BdEquipantesLog extends DataBase
{
     ...
     * @var string
     */
    protected $tableName = 'equipantesLog';
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            "id_equipante" => "INT NULL",             // id tabela equipantes.
            "antes"        => "VARCHAR(4096) NULL",   // JSON do estado atual.
            "depois"       => "VARCHAR(4096) NULL",   // JSON do estado final.
        ];
