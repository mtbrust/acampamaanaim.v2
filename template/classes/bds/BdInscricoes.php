...
class BdInscricoes extends DataBase
{
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            // Informações Saúde
            "alergiaR"     => "VARCHAR(1) NULL",      // Inscrito tem alergia? [1] Sim, [0] Não.
            "alergia"      => "VARCHAR(1024) NULL",   // Qual alergia?
            ...
            "conselheiro" => "VARCHAR(1024) NULL",   // Inscrito tem alguma informação para o seu conselheiro.
            ...
            "obsAcampa"    => "VARCHAR(1024) NULL",         // Ocorrências registradas com o acampante no evento.
