...
class BdDocumentosVersoes extends DataBase
{
     ...
     * @var string
     */
    protected $tableName = 'documentosVersoes';
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            "id_documento" => "INT NULL",                                  // ID do documento.
            "versao"       => "INT NULL",                                  // Versão do documento.
            "content"      => "LONGTEXT NULL",                             // Conteúdo do documento.
        ];
